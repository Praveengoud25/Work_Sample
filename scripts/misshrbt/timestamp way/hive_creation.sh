...
# define regular expression pattern to extract information from log line
pattern="copy: s3://([a-zA-Z0-9_-]+)/assetid=([0-9]+)/year=([0-9]+)/month=([0-9]+)/day=([0-9]+)/([a-zA-Z0-9._-]+) to s3://ge-power-cust-prod-([a-zA-Z0-9_-]+)/assetid=([a-zA-Z0-9_-]+)/year=([0-9]+)/month=([0-9]+)/day=([0-9]+)/([a-zA-Z0-9._-]+)"
